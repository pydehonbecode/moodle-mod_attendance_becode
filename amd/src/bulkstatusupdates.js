define([], function() {
    return {
        init: function() {
            ...
            const locationsUpdateField = updateRow.querySelector('#update_locations');
            ...
            locationsUpdateField.addEventListener('input', () => {
                setValuesToCheckedRows(locationsUpdateField.value, '.location');
            })
        }
    };
});